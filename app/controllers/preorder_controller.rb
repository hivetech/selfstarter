class PreorderController < ApplicationController
  ...
  def prefill
    ...
    # This is where all the magic happens. We create a multi-use token with
    # Amazon, letting us charge the user's Amazon account Then, if they confirm
    # the payment, Amazon POSTs us their shipping details and phone number From
    # there, we save it, and voila, we got ourselves a preorder!
